...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/m_insurance_companies', [MInsuranceCompany::class, 'index'])->name('MInsuranceCompanies.index');
    Route::get('/m_insurance_companies/create', [MInsuranceCompany::class, 'create'])->name('MInsuranceCompanies.create');
    Route::post('/m_insurance_companies', [MInsuranceCompany::class, 'store'])->name('MInsuranceCompanies.store');
    Route::get('/m_insurance_companies/{m_insurance_company}/edit', [MInsuranceCompany::class, 'edit'])->name('MInsuranceCompanies.edit');
    Route::put('/m_insurance_companies/{m_insurance_company}', [MInsuranceCompany::class, 'update'])->name('MInsuranceCompanies.update');
    Route::delete('/m_insurance_companies/{m_insurance_company}', [MInsuranceCompany::class, 'destroy'])->name('MInsuranceCompanies.destroy');
});
