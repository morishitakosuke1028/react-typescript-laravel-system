...
export default function Form({ isEdit = false, m_point_departure = null, onSuccess }: Props) {
    const { data, setData, post, put, processing, errors } = useForm({
        point_departure_name: m_point_departure?.point_departure_name ?? '',
        zip: m_point_departure?.zip ?? '',
        address: m_point_departure?.address ?? '',
    });
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        if (isEdit && m_point_departure) {
            put(`/m_point_departures/${m_point_departure.id}`, {
                onSuccess: () => {
